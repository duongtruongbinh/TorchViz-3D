...
updated: 2026-09-06T23:55:48+07:00
author: nmkhiem
...
- Keep hierarchical project cards within the resizable lesson rail at every supported width; long titles truncate and descriptions wrap without widening the card.
...
- Constrained long project titles and descriptions to the resizable lesson rail without clipping or horizontal overflow.
...
- Overflow follow-up: typecheck passed, 9/9 component wiring tests passed, production build passed.
...
- 2026-09-06 — Project-card overflow fixed and verified in the shared hierarchy rail.
