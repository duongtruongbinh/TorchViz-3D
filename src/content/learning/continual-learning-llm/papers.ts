...
const additionalPapers = [
  ...
  },
  {
    ...
    venue: 'arXiv',
    arxivId: '2403.15470',
    url: 'https://arxiv.org/abs/2403.15470',
    kind: 'misc',
  },
  {
    id: 'qi2023fine',
...
export const continualLearningLessonReferenceCoverage = [
  coverage('continual-learning-llm-overview', [
    claim('static-model-and-update-motivation', 'Static checkpoints motivate continual updates; RAG and model adaptation solve different needs.', '§1, §4.2 và §4.3.4', primary(['thulke2024climategpt', 'kaplan2020scaling', 'hoffmann2022chinchilla', 'dou2024sailor', 'vo2024vimistralx'])),
  ...
  coverage('stability-plasticity-dilemma', [claim('stability-plasticity-tradeoff', 'Continual learning must balance retention and acquisition across factors.', '§2.2', primary(['wang2024comprehensive', 'gururangan2020dont', 'jin2022lifelong', 'chaudhry2019tiny', 'qi2023fine', 'shi2024continualSurvey']))]),
  ...
  coverage('cl-settings-code-lab', [claim('cl-settings-lab-boundary', 'The lab operationalizes TIL, DIL, and CIL through task routing, domain shift, and an expanding global output space.', '§2.2.1', primary(['van2022three']))], 'Các thí nghiệm và kết quả chạy thuộc fixture của khóa học; paper chỉ được dùng để kiểm tra định nghĩa của ba setting.'),
  ...
  coverage('vertical-cl-deep-dive', [claim('vertical-specialization-pipeline', 'Vertical continuity moves a checkpoint from general pre-training toward domain and task specialization.', '§3.1', primary(['qin2023recyclable', 'shi2024continualSurvey']))]),
  coverage('vertical-forgetting', [claim('vertical-forgetting', 'Downstream specialization can reduce upstream general abilities.', '§3.1', primary(['wistuba2023', 'shi2024continualSurvey']))]),
  coverage('horizontal-cl-deep-dive', [claim('horizontal-adaptation', 'Horizontal continuity updates comparable stages over time or across domains.', '§3.2', primary(['jin2022lifelong', 'shi2024continualSurvey']))]),
  coverage('horizontal-forgetting', [claim('horizontal-forgetting', 'Forgetting can accumulate over long stage sequences and abrupt distribution shifts.', '§3.2', primary(['jin2022lifelong', 'shi2024continualSurvey']))]),
  coverage('continuity-to-learning-stages', [claim('chapter-four-continuity-map', 'The course maps vertical stages to horizontal update sequences.', '§3–§4', primary(['shi2024continualSurvey', 'shi2024unified']))]),
