export const lessonMetadata = {
  ...
  "locale": "en",
  "title": "11.6 Shrinkage for the Cox Model",
  "headings": [
...
with respect to _β_ = ( _β_ 1 _, . . . , βp_ )^(_T_) . We might take _P_ ( _β_ ) =^(�)^(_p_) _j_ =1^(_β_) _j_^(2,which) corresponds to a ridge penalty, or _P_ ( _β_ ) =^(�)^(_p_) _j_ =1^(_|βj|_, which correspondsto) a lasso penalty.
