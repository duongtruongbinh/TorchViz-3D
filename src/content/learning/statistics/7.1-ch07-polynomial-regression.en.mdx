export const lessonMetadata = {
  ...
  "locale": "en",
  "title": "7.1 Polynomial Regression",
  "headings": [
...
> 1If **C** ˆ is the 5 _×_ 5 covariance matrix of the _β_ ˆ _j_ , and if _ℓT_ 0^(=(1)^(_, x_0)^(_, x_2) 0^(_, x_3) 0^(_, x_4) 0^(),then) Var[ _f_^(ˆ) ( _x_ 0)] = _ℓ_^(_T_) 0^(**C**ˆ)^(_ℓ_0.)
