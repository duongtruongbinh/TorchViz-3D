export const lessonMetadata = {
  ...
  "locale": "en",
  "title": "13.2 The Challenge of Multiple Testing",
  "headings": [
...
<MdxCode language="table" code={"||_H_0 is True|_H_0 is False|Total|\n|---|---|---|---|\n|Reject _H_0|_V_|_S_|_R_|\n|Do Not Reject _H_0|_U_|_W_|_m −R_|\n|Total|_m_0|_m −m_0|_m_|"} />
