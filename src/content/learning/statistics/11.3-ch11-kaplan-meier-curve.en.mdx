export const lessonMetadata = {
  ...
  "locale": "en",
  "title": "11.3 The Kaplan–Meier Survival Curve",
  "headings": [
...
> 3The law of total probability states that for any two events _A_ and _B_ , Pr( _A_ ) = Pr( _A|B_ ) Pr( _B_ ) + Pr( _A|B_^(_c_) ) Pr( _B_^(_c_) ), where _B_^(_c_) is the complement of the event _B_ , i.e. it is the event that _B_ does not hold.
