...
const localizedText = {
  ...
  learningLab: {
    ...
    lessonLoading: { en: 'Loading lesson...', vi: 'Đang tải bài học...' },
    catalogLoading: { en: 'Loading course catalog...', vi: 'Đang tải mục lục khóa học...' },
    catalogLoadError: { en: 'The course catalog could not be loaded.', vi: 'Không thể tải mục lục khóa học.' },
    lessonLoadError: { en: 'This lesson could not be loaded.', vi: 'Không thể tải bài học này.' },
    searchLoadError: { en: 'Full lesson search is temporarily unavailable.', vi: 'Tìm kiếm toàn nội dung bài học đang tạm thời không khả dụng.' },
    lessonSearchLoading: { en: 'Loading full lesson search...', vi: 'Đang tải tìm kiếm toàn nội dung bài học...' },
    imageLoadError: { en: 'This lesson image could not be loaded.', vi: 'Không thể tải hình minh họa của bài học.' },
