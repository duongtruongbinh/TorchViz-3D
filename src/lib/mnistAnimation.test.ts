...
test('eases segment progress without changing endpoints', () => {
...
test('advances playback with clamped delta and speed', () => {
...
test('throttles React state sync for animation frames', () => {
