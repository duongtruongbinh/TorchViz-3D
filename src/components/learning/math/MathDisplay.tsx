...
export const MathDisplay = memo(function MathDisplay({
  ...
  return (
    <div
      role="math"
      className={`my-3.5 w-full min-w-0 max-w-full overflow-x-auto py-1 text-center text-[#123B68] rounded [&_.katex]:text-inherit [&_.katex-display]:my-0 [&_.katex-display]:max-w-full ${className}`}
