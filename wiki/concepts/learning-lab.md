...
The catalog contains 16 domains, 102 tracks, and 765 lesson nodes. Two hundred
ninety-seven Vietnamese-first lessons have authored content: forty-nine in
...
seven in `ai-projects`, and four tagged exercise lessons in `cv`. The other 468 nodes are navigable placeholders and render one shared localized
